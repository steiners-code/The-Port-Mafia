...
const MessageUserMediaDefault = ({ id, output, messageColors, removeContent, showClose = false, isUploading = false }: UserMediaProps) => {
...
export default MessageUserMediaDefault